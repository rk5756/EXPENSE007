...
export  const dollor = <i className="fa-solid fa-dollar-sign"></i>
export  const calender = <i className="fa-solid fa-calendar-days"></i>
export  const commnet = <i className="fa-solid fa-comment"></i>
...
export  const madical = <i className="fa-solid fa-briefcase-medical"></i>
